...
real :: temp(size(x,1)+size(y,1)),tstar(size(x,1)+size(y,1))
real :: nx(size(x,1)+size(y,1)),ny(size(x,1)+size(y,1)),ntx(size(x,1)+size(y,1)),nty(size(x,1)+size(y,1))
integer, parameter :: max_iter=2000
real :: bse(max_iter)
integer :: tmp_indx(size(x,1)+size(y,1)),indx(size(x,1)+size(y,1),2),seq(size(x,1)+size(y,1))
